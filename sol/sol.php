...
$sql_enum_persona = "SHOW COLUMNS FROM sol WHERE Field = 'persona'";
...
$sql_enum_color  = "SHOW COLUMNS FROM sol WHERE Field = 'color'";
...
$sql_enum_tratamiento  = "SHOW COLUMNS FROM sol WHERE Field = 'tratamiento'";
...
<body>
    ...
    <div class="container">
        <h2 class="mt-4 mb-4">Gafas de sol</h2>
    ...
    $sql = "SELECT persona, numero_serie, color, tratamiento, cliente_id, precio, created_at FROM sol";
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td><a href='factura_sol.php?id=" . $row['cliente_id'] . "' target='_blank' class='btn btn-secondary btn-sm'><i class='fas fa-file-pdf'></i> Descargar PDF</a></td>";
                        echo "</tr>";
                    }
                } else {
